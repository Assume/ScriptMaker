...
import scripts.ScriptMaker.api.types.intent.inventory.InventoryContainsMultipleConditional;
	...
	public BlockBuilderGUI() {
		...
		mntmInventoryContainsx_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				GUIHandler
						.addCondition(new InventoryContainsMultipleConditional(
								list.toArray(new Integer[list.size()])));
			}
		});
		mnInventory.add(mntmInventoryContainsx_1);
		...
		mntmClickFirstOf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String action = JOptionPane
						.showInputDialog("Enter action to click with: ");
				GUIHandler.setAction(new ClickFirstItemMultipleAction(list
						.toArray(new Integer[list.size()]), action));
			}
		});
		mntmItems.add(mntmClickFirstOf);
