...
public class WorldHopping
{
	...
	private final int[] WORLDS_NOT_SUPPORTED = new int[] {1, 2, 7, 8, 15, 16, 23, 24, 25, 31, 32, 37, 39, 40, 47, 48, 55, 56, 63, 64, 71, 72};
		...
		while(true && timeout > System.currentTimeMillis()) {
			if (Login.getLoginState() == STATE.INGAME) {
				...
				if(hasMisconfiguredWorldSettings()) {
					...
					Mouse.moveBox(clickArea.x, clickArea.y, clickArea.x + clickArea.width, clickArea.y + clickArea.height);
